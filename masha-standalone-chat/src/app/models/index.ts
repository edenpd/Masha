...
/**
 * Masha Chat Configuration Interface
 * This is the main configuration object for the standalone chat component
 */
export interface MashaChatConfig {
    ...
    // UI/UX (Fallback to existing styles if undefined)
